...
if(isset($_POST["btnLogin"]))
{
    ...
    if(!$error_form)
    {
        ...
        {
            session_destroy();
            die(error_page("Examen2 PHP con SW","<h1>Examen2 PHP con SW</h1><p>Error consumiendo el servicio: ".$url."</p>"));
        }

        if(isset($obj["error"]))
        {
            session_destroy();
            die(error_page("Examen2 PHP con SW","<h1>Examen2 PHP con SW</h1><p>".$obj->error."</p>"));
        }
