...
{
    session_destroy();
    die(error_page("Gestión de Guardias","<h1>Gestión de Guardias</h1><p>Sin respuesta oportuna de la API</p>"));  
}
if(isset($json["error"]))
{
    ...
    die(error_page("Gestión de Guardias","<h1>Gestión de Guardias</h1><p>".$json["error"]."</p>"));
}
