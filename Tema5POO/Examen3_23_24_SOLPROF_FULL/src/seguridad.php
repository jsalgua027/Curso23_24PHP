<?php
//$consulta="select * from usuarios where lector='".$_SESSION["usuario"]."' and clave='".$_SESSION["clave"]."'"  (copia consulta normal);
try{
...
//$variable->fetchAll(PDO::FETCH_ASSOC)
//$datos_usuario_logueado = $variable[0]['tipo'];
$sentencia=null;
